...
require('plugin.mini_bufremove')
require('plugin.mini_comment')
require('plugin.mini_hipatterns')
require('plugin.mini_move')
require('plugin.mini_pick')
require('plugin.mini_surround')
require('plugin.mini_trailspace')
require('plugin.neotab')
require('plugin.peek')
require('plugin.persistence')
require('plugin.trouble')
require('plugin.ts_context')
